...
public class FastenCURI extends FastenURI {
    ...
    public static FastenCURI create(final String rawForge, final String rawProduct, final String rawVersion,
        ...
        if (binary != null && namespace == null)
            throw new IllegalArgumentException("If binary is provided then namespace must be provided");
    ...
    public FastenCURI relativize(final FastenURI u) {
        ...
        if (rawAuthority != null && !rawAuthority.equals(uri.getRawAuthority()))
            return u instanceof FastenCURI ? (FastenCURI) u : create(u.uri);
        ...
        if (u.rawNamespace != null && !rawNamespace.equals(u.rawNamespace))
            return FastenCURI.create("/" + u.rawNamespace + "/" + u.rawEntity);
