...
public class VariableLengthByteCoder {
    ...
    public static long readLong(final InputStream is) throws IOException {
        ...
        if (x < 0xF8)
            return ((x & ~0xF8) << 32 | (long) is.read() << 24 | is.read() << 16 | is.read() << 8 | is.read()) + UPPER_BOUND_4;
        if (x < 0xFC)
            return ((x & ~0xFC) << 40 | (long) is.read() << 32 | (long) is.read() << 24 | is.read() << 16 | is.read() << 8 | is.read()) + UPPER_BOUND_5;
        if (x < 0xFE)
            return ((x & ~0xFE) << 48 | (long) is.read() << 40 | (long) is.read() << 32 | (long) is.read() << 24 | is.read() << 16 | is.read() << 8 | is.read()) + UPPER_BOUND_6;
        if (x < 0xFF)
            return ((long) is.read() << 48 | (long) is.read() << 40 | (long) is.read() << 32 | (long) is.read() << 24 | is.read() << 16 | is.read() << 8 | is.read()) + UPPER_BOUND_7;
