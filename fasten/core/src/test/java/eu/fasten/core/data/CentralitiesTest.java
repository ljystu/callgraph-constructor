...
public class CentralitiesTest {
    ...
    public void testHarmonic() throws IOException, InterruptedException {
        ...
        for (final long id : directedGraph.nodes())
            assertEquals(scores.get(id), geometricCentralities.harmonic[immutableGraph.id2Node(id)], 1E-7);
    ...
    public void testPageRank() throws IOException {
        ...
        for (final long id : directedGraph.nodes())
            assertEquals(scores.get(id), pageRankParallelGaussSeidel.rank[immutableGraph.id2Node(id)], 1E-6);
    ...
    public void testKatz() throws IOException {
        ...
        for (final long id : directedGraph.nodes())
            assertEquals(scores.get(id), katzParallelGaussSeidel.rank[immutableGraph.id2Node(id)], 1E-6);
    ...
    public void testEigenvector() throws IOException {
        ...
        for (final long id : directedGraph.nodes())
            assertEquals(salsa0[immutableGraph.id2Node(id)], salsa1.get(id), 1E-6);
    }
    ...
    public void testSeeley() throws IOException {
        ...
        for (final long id : directedGraph.nodes())
            assertEquals(dominantEigenvectorParallelPowerMethod.rank[immutableGraph.id2Node(id)], seeley.get(id));
    }
    ...
    public void testBetweenness() throws InterruptedException {
        ...
        for (final long id : directedGraph.nodes())
            assertEquals(scores.get(id), betweennessCentrality1.betweenness[immutableGraph.id2Node(id)], 1E-6);
